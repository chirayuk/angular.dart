...
class Metrics {
  ...
  int count = 0;
  //ckck final List<MetricRecord> slowestRecords;
  List<MetricRecord> slowestRecords;
  String name;
...
class DigestPhaseMetrics {
  ...
  _fmtPhaseMetrics(String prefix, Metrics m) {
    ...
    m.slowestRecords = _groupByDetail(m.slowestRecords);
...
class RootScopeMetrics {
  ...
  RootScopeMetrics(RootScopeCollectors rsCollectors):
      ...
      iterationMetrics = new Metrics.copy(rsCollectors.slowestIterations.metrics),
...
class RootScopeCollectors {
  ...
  MetricsCollector slowestIterations = new MetricsCollector("DigestLoop");
...
class StringMessageAccumulator {
  String message;
