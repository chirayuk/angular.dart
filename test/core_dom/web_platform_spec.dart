...
main() {
  describe('WebPlatform', () {
    ...
    it('should scope styles to shadow dom across browsers.',
      ...
      backend
        ..expectGET('${dynamicUrlPrefix}style.css').respond(200, 'span { background-color: red; '
            '}')
        ..expectGET('${dynamicUrlPrefix}template.html').respond(200, '<span>foo</span>');
    ...
    async((TestBed _, MockHttpBackend backend, WebPlatform platform) {
      ...
      backend
        ..expectGET('${dynamicUrlPrefix}style.css').respond(200, ':host {'
